...
def attack(char_name, char_class):
    """функция атаки принимает имя и класс."""
...
def defence(char_name, char_class):
    """функция урона принимает имя и класс."""
    if char_class == 'warrior':
    ...
    return (f'{char_class} ничего не сделал')


def special(char_name, char_class):
    """функция спец умения принимает имя и класс."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name, char_class):
    """функция выбора персонажа принимает имя и класс."""
    if char_class == 'warrior':
